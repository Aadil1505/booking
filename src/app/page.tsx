        ...
        <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
          <div>
            <h1 className="scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl">
              Razor Sharp: The Best Barber Shop.
            </h1>
          ...
          {/* Col */}
          <div className="relative ms-4 shadow-xl">
            <Image
              className="w-full rounded-md"
              src="https://images.unsplash.com/photo-1536520002442-39764a41e987?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
